...
def inputPlayerLetter():
    ...
    # Возвращает список, в котором буква игрока - первый элемент, а буква компьютера - вторая.
    letter = ''
...
def isWinner(bo, le):
    # Учитывая заполнение игрового поля и буквы игрока, эта функция возвращает True, усли игрок выиграл.
...
def getComputerMove(board, computerLetter):
    ...
    # Проверяем - победит ли игрок, сделав следующий ход, и блокирует его
    for i in range(1, 10):
        boardCopy = getBoardCopy(board)
        if isSpaceFree(boardCopy, i):
